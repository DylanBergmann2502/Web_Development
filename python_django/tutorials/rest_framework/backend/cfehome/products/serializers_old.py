# cut out since 4:26:19
from rest_framework import serializers
from rest_framework.reverse import reverse

from api.serializers import UserPublicSerializer
from backend.cfehome.api.models import Product
...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['owner',
                  ...
                  #'my_discount', # Change get_discount => my_discount
                  # 'my_user_data',
                  # 'related_products'
        ]
    ...
    # def validate_title(self, value): # validate_field
    ...
    # change the method name "get_discount" to another one
